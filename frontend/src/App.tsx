            ...
            <div className="w-screen h-screen bg-gray-900 text-white flex flex-col">
                ...
                <div className="flex justify-around mt-10 gap-8">
                    <div className="w-1/3 bg-gray-800 p-4 rounded">
                        <h2 className="text-center text-xl mb-4">Pending</h2>
                    ...
                    <div className="w-1/3 bg-gray-800 p-4 rounded">
                        <h2 className="text-center text-xl mb-4">In Progress</h2>
                    ...
                    {/* Completed Column */}
                    <div className="w-1/3 bg-gray-800 p-4 rounded">
                        <h2 className="text-center text-xl mb-4">Completed</h2>
